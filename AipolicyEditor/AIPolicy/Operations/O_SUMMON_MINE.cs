...
namespace AipolicyEditor.AIPolicy.Operations
{
    public class O_SUMMON_MINE : IOperation, ICloneable
    {
        ...
        public object Clone()
        {
            return new O_SUMMON_MINE() { LifeType = LifeType, MineID = MineID, MineIDType = MineIDType, Range = Range, Life = Life, MineNum = MineNum, MineNumType = MineNumType, Target = Target.Clone() as TargetParam  };
        }
    }
}
